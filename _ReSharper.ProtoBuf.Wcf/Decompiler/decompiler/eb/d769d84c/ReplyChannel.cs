...
namespace System.ServiceModel.Channels
{
  internal class ReplyChannel : InputQueueChannel<RequestContext>, IReplyChannel, IChannel, ICommunicationObject
  {
    ...
    {
      private static AsyncCallback onReceiveRequest = DiagnosticUtility.ThunkAsyncCallback(new AsyncCallback(ReplyChannel.HelpReceiveRequestAsyncResult.OnReceiveRequest));
